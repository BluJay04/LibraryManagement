...
function Managerdashboard() {
  ...
  <div class="col-3">
    <div class="card" style={{maxWidth:'15rem'}}>
      ...
      <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title" style={{fontSize:'18px'}}>Add products</h5>
  ...
  <div class="col-3">
    <div class="card" style={{maxWidth:'15rem'}}>
      ...
      <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title" style={{fontSize:'18px'}}>View Users</h5>
  ...
  <img src="https://img.freepik.com/premium-vector/businessman-pushed-from-cliff-bad-business-competition-concept-illustration_620585-1309.jpg?w=740" style={{height:'410px'}} class="card-img-top" alt="..."/>
  <div class="card-body">
    <h5 class="card-title" style={{fontSize:'25px',textAlign:'center'}}>Remove Users</h5>
